...
//o	Attacks always have single targets – one object can attack at most one other object at a time
...
//o	Format: create <object-type-name> <object-parameters…>
//o	Example: create tree 10 (0,0) – creates a tree with a size of 10 at the position (0, 0)
//o	Example: create guard Jack (0,0) 1 – creates guard named Jack, owned by player 1, at (0, 0)
...
//o	Format: <object-name> <command-name> <command-parameters>
//o	Commands:
//	attack (no parameters)
//	gather (no parameters)
//	go <position> 
//o	Example: Joro attack – causes the Engine to search for a IControllable object with the Name Joro and attempt to use that object as an IFighter, to attack other objects at the object’s coordinates, printing the corresponding strings for success or failure. 
//o	Example: Joro gather - causes the Engine to search for a IControllable object with the Name Joro and attempt to use that object as an IGatherer, to gather the resource at the object’s coordinates, printing the corresponding strings for success or failure.
//o	Example: Joro go (42,53) – causes the Engine to search for a IControllable object with the Name Joro and call that object’s GoTo(Point) method with a Point with coordinates (42, 53).
...
//Study the aforementioned classes to get a better understanding of how they work together.
//Tasks
...
//o	Format: create knight <name> <position> <owner> - works the same way as the create guard command, but instead creates a Knight.
//o	Example: create knight Joro (1,1) 1 – creates a Knight with the name Joro, at coordinates (1, 1) and belonging to player 1.
...
//o	Format: create house <position> <owner> - creates a house at the specified position, belonging to the specified player
//o	Example: create house (-1,-1) 2 – creates a house at coordinates (-1, -1), belonging to player 2
...
//o	Format: create giant <name> <position> - creates a giant which is at the specified position with the specified name, and is neutral (i.e. has the owner 0)
//o	Example: create giant BigGuy (10,0) – creates a giant with the name BigGuy at the coordinates (10, 0), belonging to player 0
...
//o	Format: create rock <hitpoints> <position> - creates a rock at the specified position, which has the specified hitpoints and is neutral
//o	Example: create rock 50 (7,-3) – creates a neutral rock with 50 hit points at the coordinates (7,-3).
...
//o	Format: create ninja <name> <position> <owner> - creates a ninja with the specified name, at the specified position, which belongs to the specified player.
//o	Example: create ninja Joro (0,0) 1 – creates a ninja with the name Joro, at the coordinates (0,0), belonging to player 1
...
//create guard Peter (0,0) 1
//create lumberjack Jack (1,1) 1
//create tree 10 (2,2)
//Jack go (2,2)
//Jack gather
//create guard Max (0,0) 1
//Max attack
//create guard Evil (0,0) 2
//Peter attack
//Max attack
//Peter attack
//Peter attack
//create knight EvilKnight (0,0) 2
//EvilKnight attack
//EvilKnight attack
//EvilKnight attack
//EvilKnight attack
//EvilKnight go (2,2)
//EvilKnight attack
//create giant cecameca (10,10)
//create rock 6 (10,10)
//cecameca gather
//cecameca go (2,2)
//cecameca attack
//end	Lumberjack Jack is now at position (2,2)
//Lumberjack Jack gathered 10 Lumber from Tree
//No targets to attack at Guard Max's position
//Guard Peter attacked Guard Evil and did 30 damage
//Guard Max attacked Guard Evil and did 30 damage
//Guard Peter attacked Guard Evil and did 30 damage
//Guard Peter attacked Guard Evil and did 10 damage
//Knight EvilKnight attacked Guard Peter and did 80 damage
//Knight EvilKnight attacked Guard Peter and did 20 damage
//Knight EvilKnight attacked Guard Max and did 80 damage
//Knight EvilKnight attacked Guard Max and did 20 damage
//Knight EvilKnight is now at position (2,2)
//Knight EvilKnight attacked Lumberjack Jack and did 50 damage
//Giant cecameca gathered 3 Stone from Rock
//Giant cecameca is now at position (2,2)
//Giant cecameca attacked Knight EvilKnight and did 100 damage
